    ...
    <section className={classes.root} id="contact">
      <div className={buttonContainerClassName}>
        <ButtonCard
          ...
          description={
            `Don’t see your favourite gluten free location on the map? 
            Send us your suggestions and we’ll make sure to add them`
          }
        />
        <ButtonCard
          ...
          title="Contact us"
          description={
            `Drop us a line if you feel like chatting about how we can make 
            Berlin a more gluten free friendly place.`
          }
        />
      </div>
      <CSSTransition
      ...
      >
        <div className={classes.slideInContainer}>
          ...
          <Body margin={{ bottom: 30 }}>
            Don’t see your favourite gluten free location on the map?
            Send us your suggestions below and we’ll make sure to add them!
          </Body>
          <SuggestionForm />
        </div>
      </CSSTransition>
      ...
      >
        <div className={classes.slideInContainer}>
          ...
          <Body margin={{ bottom: 30 }}>
            Drop us a line below if you feel like chatting about how we can make Berlin a
            more gluten free motherf*cking friendly place.
          </Body>
          <ContactForm />
        </div>
      </CSSTransition>
